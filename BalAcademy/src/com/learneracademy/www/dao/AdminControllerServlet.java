...
import com.learneracademy.www.model.Class1;
import com.learneracademy.www.model.Student;
import com.learneracademy.www.model.Subject;
import com.learneracademy.www.model.Teacher;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (!getCookies(request, response) && (!command.equals("LOGIN"))) {
				...
				response.sendRedirect("/BalAcademy/login.jsp");
			}
